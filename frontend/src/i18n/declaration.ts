...
export enum I18nKey {
  ...
  MODEL_SELECTOR$FREE_MODELS = "MODEL_SELECTOR$FREE_MODELS",
  MODEL_SELECTOR$PAID_MODELS = "MODEL_SELECTOR$PAID_MODELS",
  ...
  SETTINGS$OPENROUTER_API_KEY_HELP = "SETTINGS$OPENROUTER_API_KEY_HELP",
  SETTINGS$GET_OPENROUTER_KEY = "SETTINGS$GET_OPENROUTER_KEY",
}
